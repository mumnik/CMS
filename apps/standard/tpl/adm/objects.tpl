	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
					...
					<tr>
						<td>{title}</td>
						<td><a href="index.php?module=objects&action=editobject&objectid={id}" class="icon-1 info-tooltip"></a></td>
						<td><a href="index.php?module=objects&action=eraseobject&objectid={id}" class="icon-2 info-tooltip"></a></td>
					</tr>
					<!-- END: object -->
					</table>					
					<!-- END: objects --> 
