...
$tinybrowser['path']['image'] = '/uploads/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/uploads/'; // Media files location
$tinybrowser['path']['file']  = '/uploads/'; // Other files location
